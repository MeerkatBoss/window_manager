...
public:
  virtual void onMainButton(ButtonState state,
                            const math::Vec& pos,
                            gui::Canvas& canvas) { return; }

  virtual void onSecondaryButton(ButtonState state,
                                 const math::Vec& pos,
                                 gui::Canvas& canvas) { return; }
  ...
  virtual void onModifier2(ButtonState state,
                           const math::Vec& pos,
                           gui::Canvas& canvas) { return; }

  virtual void onModifier3(ButtonState state,
                           const math::Vec& pos,
                           gui::Canvas& canvas) { return; }
